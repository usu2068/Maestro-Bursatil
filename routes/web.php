...
Route::get('/videoteca', 'VideotecaController@index');
Route::post('/videoteca/categori', 'VideotecaController@list_vid');
Route::post('/videoteca/categori/video', 'VideotecaController@video');
...
Route::post('/tutorial/apoyo', 'TutoriaController@cambio_apoyo');
Route::post('/tutorial/timer', 'TutoriaController@saveTimeTuto');
Route::post('/tutorial/envquiz', 'TutoriaController@guard_quiz');
